...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, n_actions, fc1_dims=150, fc2_dims=256, name='critic', chkpt_dir='tmp/sac'):
        """
...
class ValueNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims=150, fc2_dims=256, name='value', chkpt_dir='tmp/sac'):
        """
